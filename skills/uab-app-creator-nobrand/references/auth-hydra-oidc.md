    ...
    return (
      <Box sx={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', px: 2 }}>
        <Container maxWidth="xs" sx={{ textAlign: 'center' }}>
          {/* Use /uab-logo-white.png (copied to public/ by the uab-branding
              Skill call — see scaffold-web-nextjs.md's LAYOUT section).
              This Box sits on theme.palette.background.default, which is
              light in light mode, so wrap the logo in a small UAB Green
